 ...
 * @author himorii
 */
public class DashboardApotekerFrame extends JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DashboardApotekerFrame.class.getName());
     ...
     */
    public DashboardApotekerFrame() {
        initComponents();

        setTitle("Dashboard Apoteker");
    ...
    private void initCustomLayout() {
        ...
        SiderbarApotekerPanel sidebar = new SiderbarApotekerPanel(this);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DashboardApotekerFrame().setVisible(true));
    }

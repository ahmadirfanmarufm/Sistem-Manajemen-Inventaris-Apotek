...
public class TambahStokKeluar extends javax.swing.JPanel {
    ...
    try{
        ...
        if(itemDipilih instanceof com.apotek.model.ObatOTC){
            MainApp.stokService.kurangiStok((com.apotek.model.ObatOTC) itemDipilih, jumlahKeluar, alasan);
        }
        
        else if(itemDipilih instanceof com.apotek.model.BahanRacikan){
            MainApp.stokService.kurangiStok((com.apotek.model.BahanRacikan) itemDipilih, jumlahKeluar, alasan);
        }
        
        
        else if(itemDipilih instanceof com.apotek.model.NonObat){
            MainApp.stokService.kurangiStok((com.apotek.model.NonObat) itemDipilih, jumlahKeluar, alasan);
        }
